...
from ..logger import log_model_action_error, logger
        ...
        async def stream_events():
            ...
            with TraceCtxManager(
                ...
                try:
                    ...
                    log_model_action_error(logger, "Error processing single voice turn", e)
        ...
        async def process_turns():
            ...
            with TraceCtxManager(
                ...
                try:
                    ...
                    log_model_action_error(logger, "Error processing voice turns", e)
                    await output._add_error(e)
                    raise e
                finally:
