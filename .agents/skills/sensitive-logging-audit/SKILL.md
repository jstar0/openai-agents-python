...
Inspect every new, removed, or count-changed fingerprint group. Duplicate groups deliberately require group-level re-review instead of inheriting an order-dependent disposition.
